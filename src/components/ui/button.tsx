  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white shadow-primary hover:shadow-lg transform hover:scale-105 transition-bounce font-semibold",
        accent: "bg-accent text-accent-foreground hover:bg-accent-light shadow-accent transition-smooth",
        success: "bg-success text-success-foreground hover:bg-success/90 transition-smooth",
        gradient: "gradient-primary text-white shadow-primary hover:shadow-lg transition-smooth",
      },
      size: {
